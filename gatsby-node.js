...
exports.sourceNodes = async (
  { actions, createNodeId, createContentDigest, store, getNodes, reporter },
  configOptions
) => {
  ...
  let nbEntries = 0;
  const activity = reporter.activityTimer("Fetching wallabag articles");
  activity.start();
  ...
  do {
    ...
    activity.setStatus(`number of articles fetched: ${nbEntries}`);
